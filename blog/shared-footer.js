// Shared footer for all blog posts
// Usage: Add <div id="blog-post-footer"></div> where you want the footer to appear
// Then include this script: <script src="../shared-footer.js"></script>
